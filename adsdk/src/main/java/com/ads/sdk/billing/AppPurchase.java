...
import com.ads.sdk.funtion.BillingListener;
import com.ads.sdk.funtion.PurchaseListener;
import com.ads.sdk.funtion.UpdatePurchaseListener;
...
//        SdkLogEventManager.onTrackRevenuePurchase((float) price, currency, idPurchaseCurrent, typeIap);
//
//        if (purchaseListener != null) {
//            isPurchase = true;
