...
import com.ads.sdk.dialog.ResumeLoadingDialog;
...
public class AppOpenManager implements Application.ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    public void fetchAd(final boolean isSplash) {
        ...
        if (AppPurchase.getInstance().isPurchased(myApplication.getApplicationContext())) {
            return;
        }
//        Log.d(TAG, "fetchAd: isShowingAd = " + isAdAvailable(isSplash));

        if (isAdAvailable(isSplash)) {
            return;
        }

        Log.d(TAG, "fetchAd: loadadssss = " + appResumeAdId + "->" + isSplash);
                    ...
                    public void onAdLoaded(AppOpenAd ad) {
                        ...
                        if (!isSplash) {
                            ...
                            AppOpenManager.this.appResumeAd.setOnPaidEventListener(adValue -> {
                                SdkLogEventManager.logPaidAdImpression(myApplication.getApplicationContext(),
                                        adValue,
                                        ad.getAdUnitId(),
                                        ad.getResponseInfo()
...
//        }
    ...
    public void showAdIfAvailable(final boolean isSplash) {
        ...
        if (!isShowingAd && isAdAvailable(isSplash)) {
            ...
            Log.d(TAG, "Ad is not ready" + isSplash);
            if (!isSplash) {
                fetchAd(false);
            }
                    ...
                    splashAd.setFullScreenContentCallback(
                            new FullScreenContentCallback() {
                                ...
                                public void onAdClicked() {
                                    super.onAdClicked();
                                    if (currentActivity != null) {
                                        SdkLogEventManager.logClickAdsEvent(currentActivity, splashAdId);
    ...
    private void showResumeAds() {
        Log.e("showResumeAds", "=>" + isSplashScreen);
            ...
            if (appResumeAd != null) {
                appResumeAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                    ...
                    public void onAdClicked() {
                        super.onAdClicked();
                        if (currentActivity != null) {
                            SdkLogEventManager.logClickAdsEvent(currentActivity, appResumeAdId);
                            if (fullScreenContentCallback != null) {
                                fullScreenContentCallback.onAdClicked();
                            }
                        }
                ...
                new AppOpenAd.AppOpenAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull AppOpenAd appOpenAd) {
                        ...
                        appOpenAd.setOnPaidEventListener(adValue -> {
                            ...
                            SdkLogEventManager.logPaidAdjustWithToken(adValue, appOpenAd.getAdUnitId(), SdkAdConfig.ADJUST_TOKEN_TIKTOK);
                        });
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        interstitialAd.setOnPaidEventListener(adValue -> {
                            SdkLogEventManager.logPaidAdImpression(activity,
                                    adValue,
                                    interstitialAd.getAdUnitId(),
                                    interstitialAd.getResponseInfo()
                                            .getMediationAdapterClassName(), AdType.INTERSTITIAL);
                            SdkLogEventManager.logPaidAdjustWithToken(adValue, interstitialAd.getAdUnitId(), SdkAdConfig.ADJUST_TOKEN_TIKTOK);
                        });
...
//                                adCallback.onAdClosed();
//                            }
                            if (dialogSplash != null && !AppOpenManager.this.currentActivity.isDestroyed()) {
                                try {
...
//                            }
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            SdkLogEventManager.logClickAdsEvent(context, splashAdId);
    ...
    public void onResume() {
        ...
        if (!isInitialized) {
            Log.d(TAG, "onResume: app resume is isInitialized");
            return;
        }
...
//        }
    ...
    public void loadOpenAppAdSplash(Context context, String idResumeSplash, final long timeDelay, long timeOut, final boolean isShowAdIfReady, AdCallback adCallback) {
...
//                    }
            ...
            Log.e("JJJJJJ", "adUnitId" + adUnitId);
