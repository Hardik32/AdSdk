...
public class SdkLogEventManager {

    private static final String TAG = "SdkLogEventManager";
    ...
    public static void logPaidAdImpression(Context context, AdValue adValue, String adUnitId, String mediationAdapterClassName, AdType adType) {
        logEventWithAds(context, (float) adValue.getValueMicros(), adValue.getPrecisionType(), adUnitId, mediationAdapterClassName, SdkAdConfig.PROVIDER_ADMOB);
        SdkAdjust.pushTrackEventAdmob(adValue);
...
//        SdkAdjust.pushTrackEventApplovin(adValue, context);
//
...
//    }
    ...
    private static void logPaidAdImpressionValue(Context context, double value, int precision, String adunitid, String network, int mediationProvider) {
        ...
        SdkAdjust.logPaidAdImpressionValue(value, "USD");
...
//        SdkAdjust.pushTrackEventApplovin(ad, context);
//    }
}
